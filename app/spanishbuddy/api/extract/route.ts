    ...
    const openaiResponse = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "Name grammar concepts consistently with their conventional Spanish heading, for example 'Pretérito indefinido', so repeated uploads can enrich the same learning topic. The mini-explanation must stand on its own for a learner who has forgotten the concept.",
