export const SPANISH_BUDDY_PRACTICE_INSTRUCTIONS = [
  ...
  "interactionMode is authoritative. For multiple-choice, the learner selects a button; for every other currently written mode, the learner types an answer. Never ask the learner to think, speak to themselves, or reveal an answer.",
  ...
  "When interactionMode is multiple-choice, provide exactly four distinct, similarly plausible options from the same semantic or grammatical field. The correct answer must appear exactly once. For every other interactionMode, return an empty options array.",
